/**
 * FileName: WaterMarkSystemPropertyExceptionTest
 * Author:   HuangTaiHong
 ...
 */
@Slf4j
public class WaterMarkSystemPropertyExceptionTest {
    ...
    @Before
    public void init() {
        System.setProperty(ConfigsSupport.NETTY_BUFFER_HIGH_WATERMARK, Integer.toString(2));
        System.setProperty(ConfigsSupport.NETTY_BUFFER_LOW_WATERMARK, Integer.toString(1));
    ...
    public void testServerSyncUsingConnection() throws Exception {
        ...
        Assert.assertNotNull((remoteAddr = serverUserProcessor.getRemoteAddress()));
